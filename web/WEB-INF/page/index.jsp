        ...
        <div class="layui-side-scroll" id="left1">
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="layui-icon" target="iframe_context" href="/doCustomer/showCustomer?pageNumber=1" style="color:#9FC105">&#xe770;&nbsp;&nbsp;顾客管理</a>
                    <dl class="layui-nav-child">
                        <!--a标签中写ifream的name 则点击超链接 就会在指定name的ifream中显示-->
                        <dd><a target="iframe_context" href="/doCustomer/showCustomer?pageNumber=1">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context" href="/doGoods/locationAddGoods">添加商品</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
